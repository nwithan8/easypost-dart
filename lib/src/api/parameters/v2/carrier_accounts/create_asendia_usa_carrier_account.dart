...
@reflector
class CreateAsendiaUsaCarrierAccount extends CreateCarrierAccount {
  @JsonParameter(
  ...
  CreateAsendiaUsaCarrierAccount() : super(CarrierAccountType.asendiaUsa, defaultCarrierAccountCreationEndpoint);
}
