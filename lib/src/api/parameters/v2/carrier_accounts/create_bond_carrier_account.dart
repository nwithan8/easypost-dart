...
@reflector
class CreateBondCarrierAccount extends CreateCarrierAccount {
  @JsonParameter(
  ...
  CreateBondCarrierAccount() : super(CarrierAccountType.bond, defaultCarrierAccountCreationEndpoint);
}
