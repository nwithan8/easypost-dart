...
@reflector
class CreateInterlinkCarrierAccount extends CreateCarrierAccount {
  @JsonParameter(
  ...
  @JsonParameter(
      Necessity.required, ['carrier_account', "credentials", "vat_number"])
  String? vatNumber;

  CreateInterlinkCarrierAccount()
      : super(CarrierAccountType.interlinkExpress,
