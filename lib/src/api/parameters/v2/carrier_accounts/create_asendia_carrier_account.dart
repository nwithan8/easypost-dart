...
@reflector
class CreateAsendiaCarrierAccount extends CreateCarrierAccount {
  @JsonParameter(
  ...
  CreateAsendiaCarrierAccount() : super(CarrierAccountType.asendia, defaultCarrierAccountCreationEndpoint);
}
