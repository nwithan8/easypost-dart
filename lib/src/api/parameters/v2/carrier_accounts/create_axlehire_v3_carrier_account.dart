...
@reflector
class CreateAxlehireV3CarrierAccount extends CreateCarrierAccount {
  @JsonParameter(
  ...
  CreateAxlehireV3CarrierAccount() : super(CarrierAccountType.axlehireV3, defaultCarrierAccountCreationEndpoint);
}
