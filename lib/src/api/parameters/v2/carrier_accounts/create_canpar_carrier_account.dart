...
@reflector
class CreateCanparCarrierAccount extends CreateCarrierAccount {
  @JsonParameter(
  ...
  CreateCanparCarrierAccount()
      : super(CarrierAccountType.canpar, defaultCarrierAccountCreationEndpoint);
}
