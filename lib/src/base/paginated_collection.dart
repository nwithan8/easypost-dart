...
class PaginatedCollection<ListObjectType extends ReadOnlyModelWithId,
    ListParametersType extends Parameters> extends ReadOnlyModel {
  ...
  ListParametersType? buildGetNextPageParameters(
      List<ListObjectType>? currentPageItems,
      {int? pageSize}) {
    return filters;
  }
